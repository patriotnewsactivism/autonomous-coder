...
const PROVIDERS: Record<ProviderName, ProviderConfig> = {
  ...
  gemini: {
    ...
    models: [
      ...
      { id: "gemini-1.5-flash", label: "Gemini 1.5 Flash", contextWindow: 1000000, pricing: [0, 0] },
      { id: "gemini-1.5-flash-8b", label: "Gemini 1.5 Flash 8B", contextWindow: 1000000, pricing: [0, 0] },
    ],
    isFree: true,
  },
  cerebras: {
...
export function getFallbackChain(): string[] {
  const chain: string[] = [];
  const order: ProviderName[] = ["deepseek", "groq", "gemini", "cerebras", "github", "cohere"];
